...
def run(dataset_dir, small_object_area_threshold, foreground_class_of_interest):
  ...
  Args:
    ...
    small_object_area_threshold: Threshold of fraction of image area below which small objects are filtered
  ...
  # if not tf.io.gfile.IsDirectory(coco_dir):
